...
function Section5() {
  ...
  return (
    <div className="md:h-[700px] bg-white">
      <div className="w-full h-full py-10 md:py-0 md:flex-row flex-col-reverse bg-opacity-60 flex justify-between items-center">
        <div className="md:w-[60%] px-10 flex flex-col gap-10">
          <span className="text-[#FDB42D] font-bold text-5xl">
            {t("tilte_section5")}
          </span>
          <div className="flex flex-col gap-5 text-black items-start">
        ...
        <div className="md:w-[40%] px-10 mb-5 md:mb-0">
          <div
            ...
            className="h-[250px] w-[250px] md:h-[350px] md:w-[350px] lg:h-[500px] lg:w-[500px] rounded-full bg-center bg-cover border-[5px] border-black"
          ></div>
        </div>
      </div>
    </div>
