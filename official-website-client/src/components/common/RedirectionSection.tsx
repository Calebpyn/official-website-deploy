...
const RedirectionSection: React.FC<redirectionSectionType> = ({
  ...
  return (
    ...
    >
      <div className="bg-[#D4A857] w-full h-full bg-opacity-50 flex justify-around items-center px-3 md:px-0">
        <span className="text-white md:text-5xl text-2xl font-bold text-wrap max-w-[500px]">{t(`${title}`)}</span>
        <button
